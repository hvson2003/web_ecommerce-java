...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public String addProduct(String prodName, String prodType, String prodInfo, int prodPrice, int prodQuantity,
	...
	public String addProduct(ProductBean product) {
		...
		try {
			...
			ps.setInt(5, product.getProdPrice());
	...
	public String updateProduct(ProductBean prevProduct, ProductBean updatedProduct) {
		...
		try {
			...
			ps.setInt(4, updatedProduct.getProdPrice());
	...
	@Override
	public String updateProductPrice(String prodId, int updatedPrice) {
	...
	public List<ProductBean> getAllProducts() {
		...
		try {
			...
			while (rs.next()) {
				...
				product.setProdPrice(rs.getInt(5));
	...
	@Override
	public int getProductPrice(String prodId) {
		int price = 0;
