	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Ecommerce Website</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Ecommerce Website.<br>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 VND for the first product purchase. To avail this offer you only have "
