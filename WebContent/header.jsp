...
<body>
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #e3f2fd; padding: 5px;">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="userHome.jsp"><span class="glyphicon glyphicon-home">Products</span></a>
                        </li>
                        <li class="dropdown">
                        ...
                        %>
                            <li>
                                <a href="cartDetails.jsp"> <span class="glyphicon glyphicon-shopping-cart"></span>Cart</a>
                            </li>
                        <%
                        } else {
                        %>
